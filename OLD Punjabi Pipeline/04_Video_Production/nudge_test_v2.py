...
def render_with_nudge(text, nudge_x=0, nudge_y=0, output_path="nudge.png"):
    ...
    # We try moving it RIGHT (positive nudge_x) and DOWN/UP
...
if __name__ == "__main__":
    ...
    # Try moving it RIGHT (0 to 15) and keep it low (10 to 15)
    render_with_nudge(word, nudge_x=0, nudge_y=10, output_path=os.path.join(test_dir, "Nudge_0x_10y.png"))
    render_with_nudge(word, nudge_x=5, nudge_y=12, output_path=os.path.join(test_dir, "Nudge_5x_12y.png"))
    render_with_nudge(word, nudge_x=10, nudge_y=15, output_path=os.path.join(test_dir, "Nudge_10x_15y.png"))
    render_with_nudge(word, nudge_x=15, nudge_y=15, output_path=os.path.join(test_dir, "Nudge_15x_15y.png"))
