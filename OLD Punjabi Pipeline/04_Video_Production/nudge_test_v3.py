...
if __name__ == "__main__":
    ...
    # Moving further right than 15x
    render_with_nudge(word, nudge_x=20, nudge_y=15, output_path=os.path.join(test_dir, "Nudge_20x_15y.png"))
    render_with_nudge(word, nudge_x=25, nudge_y=15, output_path=os.path.join(test_dir, "Nudge_25x_15y.png"))
    render_with_nudge(word, nudge_x=30, nudge_y=15, output_path=os.path.join(test_dir, "Nudge_30x_15y.png"))
